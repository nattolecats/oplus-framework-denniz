...
# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmCallbackCache(Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;->mCallbackCache:Ljava/util/Map;

    return-object p0
.end method

.method static bridge synthetic blacklist -$$Nest$mgetRule(Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$monQueryResult(Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;Landroid/content/Context;Ljava/lang/String;Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$QueryCallback;)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mupdateCache(Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;Landroid/content/Context;ZLjava/lang/String;)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mupdateCallback(Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;Ljava/lang/String;Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$QueryCallback;)V
    .locals 0
...
.method private blacklist updateCallback(Ljava/lang/String;Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$QueryCallback;)V
    ...
    const-string v8, "updateCallback : "
...
# virtual methods
.method public blacklist registerObserver(Landroid/content/Context;)V
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
    ...
    iget-boolean v0, p0, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;->mObserved:Z

    if-nez v0, :cond_1

    .line 76
    sget-object v0, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;->URI_RULE:Landroid/net/Uri;

    .line 77
    .local v0, "uri":Landroid/net/Uri;
    iget-object v1, p0, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;->mRulesObserver:Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$RulesObserver;

    if-nez v1, :cond_0

    .line 78
    new-instance v1, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$RulesObserver;

    iget-object v2, p0, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;->mHandler:Landroid/os/Handler;

    invoke-direct {v1, p0, v2, p1, v0}, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$RulesObserver;-><init>(Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;Landroid/os/Handler;Landroid/content/Context;Landroid/net/Uri;)V

    iput-object v1, p0, Lcn/teddymobile/free/anteater/resources/RuleResourcesServer;->mRulesObserver:Lcn/teddymobile/free/anteater/resources/RuleResourcesServer$RulesObserver;
...
.method public blacklist unregisterObserver()V
    .locals 5
