...
# virtual methods
.method public blacklist check(Landroid/view/View;)Z
    .locals 1
...
.method public blacklist check(Ljava/lang/String;Landroid/view/View;)Z
    .locals 6
    ...
    .line 159
    instance-of v3, v1, Lcn/teddymobile/free/anteater/rule/trigger/context/ContextRule;
    ...
    check-cast v3, Lcn/teddymobile/free/anteater/rule/trigger/context/ContextRule;

    .line 161
    .local v3, "contextRule":Lcn/teddymobile/free/anteater/rule/trigger/context/ContextRule;
    invoke-virtual {v3, p1, p2}, Lcn/teddymobile/free/anteater/rule/trigger/context/ContextRule;->fitAction(Ljava/lang/String;Landroid/view/View;)Z
    ...
    invoke-static {v2, v4}, Lcn/teddymobile/free/anteater/logger/Logger;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 165
    .end local v3    # "contextRule":Lcn/teddymobile/free/anteater/rule/trigger/context/ContextRule;
    goto :goto_2

    :cond_1
    instance-of v3, v1, Lcn/teddymobile/free/anteater/rule/trigger/hierarchy/ViewHierarchyRule;
    ...
    check-cast v3, Lcn/teddymobile/free/anteater/rule/trigger/hierarchy/ViewHierarchyRule;

    .line 167
    .local v3, "viewHierarchyRule":Lcn/teddymobile/free/anteater/rule/trigger/hierarchy/ViewHierarchyRule;
    invoke-virtual {v3, p1, p2}, Lcn/teddymobile/free/anteater/rule/trigger/hierarchy/ViewHierarchyRule;->fitAction(Ljava/lang/String;Landroid/view/View;)Z
    ...
    .line 171
    .end local v3    # "viewHierarchyRule":Lcn/teddymobile/free/anteater/rule/trigger/hierarchy/ViewHierarchyRule;
    goto :goto_2

    :cond_3
    instance-of v3, v1, Lcn/teddymobile/free/anteater/rule/trigger/resource/ResourceNameRule;
    ...
    check-cast v3, Lcn/teddymobile/free/anteater/rule/trigger/resource/ResourceNameRule;

    .line 173
    .local v3, "resourceNameRule":Lcn/teddymobile/free/anteater/rule/trigger/resource/ResourceNameRule;
    invoke-virtual {v3, p1, p2}, Lcn/teddymobile/free/anteater/rule/trigger/resource/ResourceNameRule;->fitAction(Ljava/lang/String;Landroid/view/View;)Z
    ...
    .end local v3    # "resourceNameRule":Lcn/teddymobile/free/anteater/rule/trigger/resource/ResourceNameRule;
    goto :goto_1

    .line 177
    :cond_5
    instance-of v3, v1, Lcn/teddymobile/free/anteater/rule/trigger/text/TextRule;
    ...
    check-cast v3, Lcn/teddymobile/free/anteater/rule/trigger/text/TextRule;

    .line 179
    .local v3, "textRule":Lcn/teddymobile/free/anteater/rule/trigger/text/TextRule;
    invoke-virtual {v3, p1, p2}, Lcn/teddymobile/free/anteater/rule/trigger/text/TextRule;->fitAction(Ljava/lang/String;Landroid/view/View;)Z
    ...
    .line 177
    .end local v3    # "textRule":Lcn/teddymobile/free/anteater/rule/trigger/text/TextRule;
    :cond_7
    :goto_1
    nop
...
.method public blacklist extract(Ljava/lang/String;Landroid/view/View;)Lorg/json/JSONObject;
    .locals 6
    .param p1, "action"    # Ljava/lang/String;
    .param p2, "view"    # Landroid/view/View;
    .annotation system Ldalvik/annotation/Throws;
...
.method public blacklist getParser()Ljava/lang/String;
    .locals 1
...
.method public blacklist getScene()Ljava/lang/String;
    .locals 1
