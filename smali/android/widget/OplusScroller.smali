...
.field public whitelist mDeceleration:F
...
.method public whitelist computeScrollOffset()Z
    ...
    iget v3, p0, Landroid/widget/OplusScroller;->mMode:I
    ...
    iget v5, p0, Landroid/widget/OplusScroller;->mLastCurrV:I
    ...
    .line 297
    iput v5, p0, Landroid/widget/OplusScroller;->mCurrV:I
    ...
    iput v4, p0, Landroid/widget/OplusScroller;->mLastCurrY:I

    .line 311
    iget v5, p0, Landroid/widget/OplusScroller;->mCurrX:I

    iget v7, p0, Landroid/widget/OplusScroller;->mFinalX:I
    ...
    .line 312
    :cond_6
    iput v4, p0, Landroid/widget/OplusScroller;->mFinalY:I

    .line 313
    iput-boolean v6, p0, Landroid/widget/OplusScroller;->mFinished:Z
    ...
    iput v9, p0, Landroid/widget/OplusScroller;->mCurrY:I

    .line 356
    iget v8, p0, Landroid/widget/OplusScroller;->mCurrX:I
    ...
    .line 358
    :cond_7
    iget v4, p0, Landroid/widget/OplusScroller;->mDeltaX:F
    ...
    iget v2, p0, Landroid/widget/OplusScroller;->mDeltaY:F
    ...
    invoke-virtual/range {v7 .. v12}, Landroid/widget/OplusScroller;->startScroll(IIIII)V

    .line 361
    iput v5, p0, Landroid/widget/OplusScroller;->mMode:I
    ...
    iget v9, p0, Landroid/widget/OplusScroller;->mCurrY:I
