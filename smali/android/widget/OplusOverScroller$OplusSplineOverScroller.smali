...
# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmCurrVelocity(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)F
    .locals 0

    iget p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mCurrVelocity:F

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmCurrentPosition(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    .locals 0

    iget p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mCurrentPosition:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmDuration(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    .locals 0

    iget p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mDuration:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmFinal(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    .locals 0

    iget p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mFinal:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmFinished(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)Z
    .locals 0

    iget-boolean p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mFinished:Z

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmStart(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    .locals 0

    iget p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mStart:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmStartTime(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)J
    .locals 2
...
.method static bridge synthetic blacklist -$$Nest$fgetmState(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    .locals 0

    iget p0, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mState:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fputmFinished(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;Z)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$fputmIsScrollList(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;Z)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$fputmOrigamiFriction(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;F)V
    .locals 0
...
.method private blacklist fitOnBounceCurve(III)V
    ...
    .line 988
    invoke-static {}, Landroid/widget/OplusOverScroller;->-$$Nest$sfgetDBG()Z
...
.method private blacklist onEdgeReached()V
    ...
    const-string v4, "onEdgeReached() mVelocity="
    ...
    const-string v6, "onEdgeReached() mFinal="
...
.method private blacklist startAfterEdge(IIII)V
    ...
    const-string v2, "startAfterEdge() start="
...
.method private blacklist startBounceAfterEdge(III)V
    ...
    const-string v1, "startBounceAfterEdge() start="
...
.method blacklist continueWhenFinished()Z
    ...
    iget v2, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mStart:I

    invoke-direct {p0, v0, v2, v1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->startSpringback(III)V
    ...
    .line 1111
    iput v1, p0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mScrollerDistance:I
...
.method blacklist fling(IIIII)V
    ...
    .line 957
    invoke-static {}, Landroid/widget/OplusOverScroller;->-$$Nest$sfgetsOverscrollDistance()I
...
.method blacklist notifyEdgeReached(III)V
    ...
    const-string v1, "notifyEdgeReached() start="
...
.method blacklist springback(III)Z
    ...
    const-string v1, "springback start="
...
.method blacklist update()Z
    ...
    const-string v10, "update() mState="
    ...
    const-string v12, "update mSplineState == OVER_SPLINE x="
    ...
    :cond_5
    iget-boolean v7, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mIsScrollList:Z
    ...
    invoke-static {v7, v8}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->viscousFluid(FF)F

    move-result v7

    .line 1264
    iget v8, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mFinal:I
    ...
    const-string v12, "update while mOplusCount="

    invoke-virtual {v8, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v12, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mOplusCount:I
    ...
    .line 1270
    :cond_6
    iput-boolean v6, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mOverSplineStart:Z
    ...
    :cond_7
    iget-boolean v7, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mOverSplineStart:Z
    ...
    iget v9, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mDuration:I
    ...
    iget v9, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mStart:I
    ...
    .line 1279
    .local v12, "nextDistance":D
    if-gez v8, :cond_8

    sub-double v14, v12, v10

    iget v9, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mScrollerDistance:I
    ...
    iget v8, v0, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->mScrollerDistance:I
    ...
    const-string v2, "update CUBIC x="
    ...
    .end local v8    # "dxdt":D
    .end local v12    # "dVelocity":D
    .end local v14    # "cVelocity":D
    .end local v20    # "dvdt":D
    .end local v22    # "bVelocity":D
    .end local v24    # "tempVelocity":D
    .end local v26    # "aAcceleration":D
    .end local v28    # "tempPosition":D
    .end local v30    # "x":F
    .end local v31    # "aVelocity":D
    .end local v33    # "velocity":D
    .end local v35    # "position":D
    .end local v40    # "dAcceleration":D
    .end local v42    # "timePassed":I
    .end local v43    # "bAcceleration":D
    .local v5, "timePassed":I
    .restart local v7    # "x":F
    .local v10, "distance":D
    :goto_9
