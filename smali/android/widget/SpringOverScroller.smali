...
.field public static final whitelist OPLUS_FLING_FRICTION_FAST:F = 0.76f

.field public static final whitelist OPLUS_FLING_FRICTION_LIST_OPTIMIZE:F = 0.008f

.field public static final whitelist OPLUS_FLING_FRICTION_NORMAL:F = 1.06f
...
.method public static whitelist newInstance(Landroid/content/Context;Z)Landroid/widget/OverScroller;
    ...
    invoke-static {v2, p1}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fputmIsScrollView(Landroid/widget/SpringOverScroller$ReboundOverScroller;Z)V
...
.method public whitelist computeScrollOffset()Z
    ...
    invoke-static {v2}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fgetmScrollStartTime(Landroid/widget/SpringOverScroller$ReboundOverScroller;)J
    ...
    iget-object v4, p0, Landroid/widget/SpringOverScroller;->mScrollerX:Landroid/widget/SpringOverScroller$ReboundOverScroller;

    invoke-static {v4}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fgetmScrollDuration(Landroid/widget/SpringOverScroller$ReboundOverScroller;)I
    ...
    .line 122
    iget-object v5, p0, Landroid/widget/SpringOverScroller;->mInterpolator:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v6, v5}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->updateScroll(F)V
    ...
    .line 126
    :cond_1
    iget-object v5, p0, Landroid/widget/SpringOverScroller;->mScrollerX:Landroid/widget/SpringOverScroller$ReboundOverScroller;

    const/high16 v6, 0x3f800000    # 1.0f

    invoke-virtual {v5, v6}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->updateScroll(F)V

    .line 127
    iget-object v5, p0, Landroid/widget/SpringOverScroller;->mScrollerY:Landroid/widget/SpringOverScroller$ReboundOverScroller;
...
.method public whitelist fling(IIII)V
    .locals 1
    .param p1, "startX"    # I
    .param p2, "startY"    # I
...
.method public final whitelist getOplusCurrX()I
    .locals 2
...
.method public final whitelist getOplusCurrY()I
    .locals 2
...
.method public final whitelist getOplusFinalX()I
    .locals 2
...
.method public final whitelist getOplusFinalY()I
    .locals 2
...
.method public final whitelist isOplusFinished()Z
    .locals 1
...
.method public whitelist isScrollingInDirection(FF)Z
    ...
    invoke-static {v0}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fgetmEndValue(Landroid/widget/SpringOverScroller$ReboundOverScroller;)D

    move-result-wide v0

    iget-object v2, p0, Landroid/widget/SpringOverScroller;->mScrollerX:Landroid/widget/SpringOverScroller$ReboundOverScroller;

    invoke-static {v2}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fgetmStartValue(Landroid/widget/SpringOverScroller$ReboundOverScroller;)D
    ...
    invoke-static {v1}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fgetmEndValue(Landroid/widget/SpringOverScroller$ReboundOverScroller;)D

    move-result-wide v1

    iget-object v3, p0, Landroid/widget/SpringOverScroller;->mScrollerY:Landroid/widget/SpringOverScroller$ReboundOverScroller;

    invoke-static {v3}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fgetmStartValue(Landroid/widget/SpringOverScroller$ReboundOverScroller;)D
...
.method public whitelist setFlingFriction(F)V
    ...
    invoke-static {v0, p1}, Landroid/widget/SpringOverScroller$ReboundOverScroller;->-$$Nest$fputmFlingFriction(Landroid/widget/SpringOverScroller$ReboundOverScroller;F)V
