...
# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmAnimationDuration(Landroid/widget/OplusResolverGallery;)I
    .locals 0

    iget p0, p0, Landroid/widget/OplusResolverGallery;->mAnimationDuration:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmIsRtl(Landroid/widget/OplusResolverGallery;)Z
    .locals 0

    iget-boolean p0, p0, Landroid/widget/OplusResolverGallery;->mIsRtl:Z

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmShouldStopFling(Landroid/widget/OplusResolverGallery;)Z
    .locals 0

    iget-boolean p0, p0, Landroid/widget/OplusResolverGallery;->mShouldStopFling:Z

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fputmDownTouchPosition(Landroid/widget/OplusResolverGallery;I)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$fputmShouldStopFling(Landroid/widget/OplusResolverGallery;Z)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$fputmSuppressSelectionChanged(Landroid/widget/OplusResolverGallery;Z)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mdispatchUnpress(Landroid/widget/OplusResolverGallery;)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mscrollIntoSlots(Landroid/widget/OplusResolverGallery;)V
    .locals 0
...
.method static synthetic blacklist access$000(Landroid/widget/OplusResolverGallery;)I
    .locals 1
...
.method static synthetic blacklist access$100(Landroid/widget/OplusResolverGallery;)I
    .locals 1
    .param p0, "x0"    # Landroid/widget/OplusResolverGallery;
...
.method static synthetic blacklist access$200(Landroid/widget/OplusResolverGallery;)I
    .locals 1
    .param p0, "x0"    # Landroid/widget/OplusResolverGallery;
...
.method static synthetic blacklist access$300(Landroid/widget/OplusResolverGallery;)I
    .locals 1
    .param p0, "x0"    # Landroid/widget/OplusResolverGallery;
...
.method public whitelist layout(IZ)V
    .locals 6
    .param p1, "delta"    # I
    .param p2, "animate"    # Z
...
.method public whitelist onInitializeAccessibilityNodeInfoInternal(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    .locals 3
...
.method blacklist onUp()V
    ...
    invoke-static {v0}, Landroid/widget/OplusResolverGallery$FlingRunnable;->-$$Nest$fgetmScroller(Landroid/widget/OplusResolverGallery$FlingRunnable;)Landroid/widget/Scroller;
...
.method public whitelist performAccessibilityActionInternal(ILandroid/os/Bundle;)Z
    .locals 4
    .param p1, "action"    # I
...
.method public whitelist setOnScrollListener(Landroid/widget/OplusResolverGallery$OnGalleryScrollListener;)V
    .locals 0
...
.method blacklist trackMotionScroll(I)V
    ...
    invoke-static {v4, v1}, Landroid/widget/OplusResolverGallery$FlingRunnable;->-$$Nest$mendFling(Landroid/widget/OplusResolverGallery$FlingRunnable;Z)V
