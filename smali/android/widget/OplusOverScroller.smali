...
.field public static final whitelist OPLUS_FLING_FRICTION_FAST:F = 1.65f

.field public static final whitelist OPLUS_FLING_FRICTION_NORMAL:F = 2.05f

.field public static final whitelist OPLUS_FLING_MODE_FAST:I = 0x0

.field public static final whitelist OPLUS_FLING_MODE_NORMAL:I = 0x1
...
.method static bridge synthetic blacklist -$$Nest$sfgetsOverscrollDistance()I
    .locals 1
...
.method public static whitelist newInstance(Landroid/content/Context;)Landroid/widget/OverScroller;
    .locals 2
...
.method public static whitelist newInstance(Landroid/content/Context;Z)Landroid/widget/OverScroller;
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    invoke-static {v2, p1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fputmIsScrollList(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;Z)V
...
.method public whitelist computeScrollOffset()Z
    ...
    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmFinished(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)Z
    ...
    invoke-static {v2}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmStartTime(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)J
    ...
    iget-object v4, p0, Landroid/widget/OplusOverScroller;->mScrollerX:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v4}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmDuration(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    ...
    .line 396
    iget-object v5, p0, Landroid/widget/OplusOverScroller;->mInterpolator:Landroid/view/animation/Interpolator;
    ...
    .line 400
    .local v5, "q":F
    iget-object v6, p0, Landroid/widget/OplusOverScroller;->mScrollerX:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-virtual {v6, v5}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->updateScroll(F)V

    .line 401
    iget-object v6, p0, Landroid/widget/OplusOverScroller;->mScrollerY:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;
...
.method public whitelist fling(IIIIIIIIII)V
    ...
    invoke-static {v3}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmCurrVelocity(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)F
    ...
    invoke-static {v4}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmCurrVelocity(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)F
...
.method public whitelist getCurrVelocity()F
    ...
    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmCurrVelocity(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)F

    move-result v0

    iget-object v1, p0, Landroid/widget/OplusOverScroller;->mScrollerX:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmCurrVelocity(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)F
    ...
    invoke-static {v2}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmCurrVelocity(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)F
...
.method public whitelist getOplusCurrX()I
    .locals 1

    .line 242
    iget-object v0, p0, Landroid/widget/OplusOverScroller;->mScrollerX:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmCurrentPosition(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
...
.method public whitelist getOplusCurrY()I
    .locals 1
...
.method public blacklist getOplusDuration()I
    ...
    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmDuration(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I

    move-result v0

    iget-object v1, p0, Landroid/widget/OplusOverScroller;->mScrollerY:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmDuration(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
...
.method public whitelist getOplusFinalX()I
    .locals 1

    .line 289
    iget-object v0, p0, Landroid/widget/OplusOverScroller;->mScrollerX:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmFinal(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
...
.method public whitelist getOplusFinalY()I
    .locals 1
...
.method public final whitelist getOplusStartX()I
    .locals 1

    .line 271
    iget-object v0, p0, Landroid/widget/OplusOverScroller;->mScrollerX:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmStart(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
...
.method public final whitelist getOplusStartY()I
    .locals 1
...
.method public whitelist isOplusFinished()Z
    .locals 1
...
.method public whitelist isOverScrolled()Z
    ...
    invoke-static {v0}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmState(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
...
.method public whitelist isScrollingInDirection(FF)Z
    .locals 4
    .param p1, "xvel"    # F
    .param p2, "yvel"    # F
    ...
    invoke-static {v1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmStart(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
    ...
    invoke-static {v1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmFinal(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I

    move-result v1

    iget-object v2, p0, Landroid/widget/OplusOverScroller;->mScrollerY:Landroid/widget/OplusOverScroller$OplusSplineOverScroller;

    invoke-static {v2}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmStart(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)I
...
.method public final whitelist oplusForceFinished(Z)V
    .locals 1
    .param p1, "finished"    # Z
    ...
    invoke-static {v0, p1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fputmFinished(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;Z)V
...
.method public whitelist setEnableScrollList(Z)V
    .locals 1
    .param p1, "flag"    # Z
    ...
    invoke-static {v0, p1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fputmIsScrollList(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;Z)V
...
.method public whitelist setFlingFriction(F)V
    ...
    invoke-static {v0, p1}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fputmOrigamiFriction(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;F)V
...
.method public whitelist setOplusFlingMode(I)V
    .locals 2
    .param p1, "mode"    # I
...
.method public whitelist setOplusFriction(F)V
    .locals 1
    .param p1, "friction"    # F
...
.method public whitelist timePassed()I
    ...
    invoke-static {v4}, Landroid/widget/OplusOverScroller$OplusSplineOverScroller;->-$$Nest$fgetmStartTime(Landroid/widget/OplusOverScroller$OplusSplineOverScroller;)J
