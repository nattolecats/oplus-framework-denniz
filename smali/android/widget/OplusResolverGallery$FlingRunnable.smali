...
# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmScroller(Landroid/widget/OplusResolverGallery$FlingRunnable;)Landroid/widget/Scroller;
    .locals 0

    iget-object p0, p0, Landroid/widget/OplusResolverGallery$FlingRunnable;->mScroller:Landroid/widget/Scroller;

    return-object p0
.end method

.method static bridge synthetic blacklist -$$Nest$mendFling(Landroid/widget/OplusResolverGallery$FlingRunnable;Z)V
    .locals 0
...
.method private blacklist endFling(Z)V
    ...
    invoke-static {v0}, Landroid/widget/OplusResolverGallery;->-$$Nest$mscrollIntoSlots(Landroid/widget/OplusResolverGallery;)V
...
.method public whitelist test-api run()V
    ...
    invoke-static {v0, v2}, Landroid/widget/OplusResolverGallery;->-$$Nest$fputmShouldStopFling(Landroid/widget/OplusResolverGallery;Z)V
    ...
    invoke-static {v5}, Landroid/widget/OplusResolverGallery;->-$$Nest$fgetmIsRtl(Landroid/widget/OplusResolverGallery;)Z
    ...
    :goto_0
    invoke-static {v5, v6}, Landroid/widget/OplusResolverGallery;->-$$Nest$fputmDownTouchPosition(Landroid/widget/OplusResolverGallery;I)V
    ...
    invoke-static {v6}, Landroid/widget/OplusResolverGallery;->access$000(Landroid/widget/OplusResolverGallery;)I
    ...
    invoke-static {v6}, Landroid/widget/OplusResolverGallery;->access$100(Landroid/widget/OplusResolverGallery;)I
    ...
    invoke-static {v6}, Landroid/widget/OplusResolverGallery;->-$$Nest$fgetmIsRtl(Landroid/widget/OplusResolverGallery;)Z
    ...
    :goto_1
    invoke-static {v6, v7}, Landroid/widget/OplusResolverGallery;->-$$Nest$fputmDownTouchPosition(Landroid/widget/OplusResolverGallery;I)V
    ...
    invoke-static {v7}, Landroid/widget/OplusResolverGallery;->access$200(Landroid/widget/OplusResolverGallery;)I
    ...
    invoke-static {v7}, Landroid/widget/OplusResolverGallery;->access$300(Landroid/widget/OplusResolverGallery;)I
    ...
    invoke-static {v5}, Landroid/widget/OplusResolverGallery;->-$$Nest$fgetmShouldStopFling(Landroid/widget/OplusResolverGallery;)Z
...
.method public blacklist startUsingDistance(I)V
    ...
    invoke-static {v0}, Landroid/widget/OplusResolverGallery;->-$$Nest$fgetmAnimationDuration(Landroid/widget/OplusResolverGallery;)I
