.class Landroid/os/HapticPlayer$3;
...
# direct methods
.method constructor blacklist <init>(Landroid/os/HapticPlayer;IIII)V
    .locals 0
    .param p1, "this$0"    # Landroid/os/HapticPlayer;

    .line 756
    iput-object p1, p0, Landroid/os/HapticPlayer$3;->this$0:Landroid/os/HapticPlayer;

    iput p2, p0, Landroid/os/HapticPlayer$3;->val$realLooper:I

    iput p3, p0, Landroid/os/HapticPlayer$3;->val$interval:I

    iput p4, p0, Landroid/os/HapticPlayer$3;->val$amplitude:I

    iput p5, p0, Landroid/os/HapticPlayer$3;->val$freq:I
...
.method public whitelist test-api run()V
    ...
    :try_start_0
    iget-object v3, p0, Landroid/os/HapticPlayer$3;->this$0:Landroid/os/HapticPlayer;
    ...
    .line 768
    :cond_0
    iget-object v4, p0, Landroid/os/HapticPlayer$3;->this$0:Landroid/os/HapticPlayer;

    iget v6, p0, Landroid/os/HapticPlayer$3;->val$realLooper:I

    iget v7, p0, Landroid/os/HapticPlayer$3;->val$interval:I

    iget v8, p0, Landroid/os/HapticPlayer$3;->val$amplitude:I

    iget v9, p0, Landroid/os/HapticPlayer$3;->val$freq:I
