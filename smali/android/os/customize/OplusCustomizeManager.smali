...
# static fields
.field public static final whitelist SERVICE_NAME:Ljava/lang/String; = "opluscustomize"
...
.method public static final whitelist getInstance()Landroid/os/customize/OplusCustomizeManager;
    .locals 2
...
.method private blacklist getOplusCustomizeManagerService()Landroid/os/customize/IOplusCustomizeService;
    ...
    .line 102
    const-string v1, "opluscustomize"
...
# virtual methods
.method public whitelist checkPermission()V
    .locals 3
...
.method public final whitelist getDeviceManagerServiceByName(Ljava/lang/String;)Landroid/os/IBinder;
    .locals 4
...
.method public whitelist isOTAUpdated()Z
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
    ...
    .line 88
    :try_start_0
    invoke-interface {v1}, Landroid/os/customize/IOplusCustomizeService;->isOTAUpdated()Z
...
.method public whitelist isPlatformSigned(I)Z
    .locals 4
    .param p1, "uid"    # I
...
.method public whitelist isSimUnlockedState()Z
    .locals 4
    ...
    .line 113
    :try_start_0
    invoke-interface {v1}, Landroid/os/customize/IOplusCustomizeService;->isSimUnlockedState()Z
    ...
    const-string v3, "isSimUnlockedState error!"
