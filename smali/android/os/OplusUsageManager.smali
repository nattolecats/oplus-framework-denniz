...
.field public static final whitelist SERVICE_NAME:Ljava/lang/String; = "usage"

.field public static final whitelist TAG:Ljava/lang/String; = "OplusUsageManager"
...
.method public static whitelist getOplusUsageManager()Landroid/os/OplusUsageManager;
    .locals 1
...
.method public whitelist readEntireOplusDir(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 895
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "saveEntireOplusDir failed!"
    ...
    .line 898
    :cond_0
    const-string v0, "saveEntireOplusDir:service not publish!"
...
.method public whitelist readEntireOplusFile(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 856
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "readEntireOplusFile failed!"
    ...
    .line 859
    :cond_0
    const-string v0, "readEntireOplusFile:service not publish!"
...
.method public whitelist readOplusFile(Ljava/lang/String;II)[B
    ...
    .line 817
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "readOplusFile failed!"
    ...
    .line 820
    :cond_0
    const-string v0, "readOplusFile:service not publish!"
...
.method public whitelist recordApkDeleteEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 643
    .local v2, "exce":Landroid/os/RemoteException;
    const-string v3, "recordApkDeleteEvent failed!"
    ...
    .line 646
    :cond_2
    const-string v2, "recordApkDeleteEvent:service not publish!"
    ...
    :cond_3
    :goto_1
    const-string v2, "recordApkDeleteEvent:callerAppPkgName empty!"
    ...
    :cond_4
    :goto_2
    const-string v2, "recordApkDeleteEvent:deleteAppPkgName empty!"
...
.method public whitelist recordApkInstallEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 717
    .local v2, "exce":Landroid/os/RemoteException;
    const-string v3, "recordApkInstallEvent failed!"
    ...
    .line 720
    :cond_2
    const-string v2, "recordApkInstallEvent:service not publish!"
    ...
    :cond_3
    :goto_1
    const-string v2, "recordApkInstallEvent:callerAppPkgName empty!"
    ...
    :cond_4
    :goto_2
    const-string v2, "recordApkInstallEvent:deleteAppPkgName empty!"
...
.method public whitelist recordMcsConnectID(Ljava/lang/String;)Z
    ...
    .line 776
    .local v2, "exce":Landroid/os/RemoteException;
    const-string v3, "recordMcsConnectID failed!"
    ...
    .line 779
    :cond_1
    const-string v2, "recordMcsConnectID:service not publish!"
    ...
    :cond_2
    :goto_1
    const-string v2, "recordMcsConnectID:connectID empty!"
...
.method public whitelist saveEntireOplusFile(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    .line 843
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "saveEntireOplusFile failed!"
    ...
    .line 846
    :cond_0
    const-string v0, "saveEntireOplusFile:service not publish!"
...
.method public whitelist saveOplusFile(ILjava/lang/String;IZI[B)I
    ...
    .line 830
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v1, "saveOplusFile failed!"
    ...
    .line 833
    :cond_0
    const-string v0, "saveOplusFile:service not publish!"
...
.method public whitelist saveSecrecyConfig(Ljava/lang/String;)I
    ...
    .line 581
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "saveSecrecyConfig failed!"
    ...
    .line 584
    :cond_0
    const-string v0, "saveSecrecyConfig:service not publish!"
...
.method public whitelist setProductLineLastTestFlag(I)Z
    ...
    .line 595
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "setProductLineLastTestFlag failed!"
    ...
    .line 598
    :cond_0
    const-string v0, "setProductLineLastTestFlag:service not publish!"
...
.method public whitelist testSaveSomeData(ILjava/lang/String;)V
    ...
    .line 47
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "testSaveSomeData failed!"
    ...
    .line 50
    :cond_0
    const-string v0, "testSaveSomeData:service not publish!"
...
.method public whitelist updateMaxChargeCurrent(I)Z
    ...
    .line 440
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "updateMaxChargeCurrent failed!"
    ...
    .line 443
    :cond_0
    const-string v0, "updateMaxChargeCurrent:service not publish!"
...
.method public whitelist updateMaxChargeTemperature(I)Z
    ...
    .line 454
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "updateMaxChargeTemperature failed!"
    ...
    .line 457
    :cond_0
    const-string v0, "updateMaxChargeTemperature:service not publish!"
...
.method public whitelist updateMinChargeTemperature(I)Z
    ...
    .line 468
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "updateMinChargeTemperature failed!"
    ...
    .line 471
    :cond_0
    const-string v0, "updateMinChargeTemperature:service not publish!"
...
.method public whitelist writePhoneCallHistoryRecord(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 426
    .local v0, "exce":Landroid/os/RemoteException;
    const-string v2, "writePhoneCallHistoryRecord failed!"
    ...
    .line 429
    :cond_0
    const-string v0, "writePhoneCallHistoryRecord:service not publish!"
