...
# static fields
.field public static final whitelist ARGS_HIGHT_LIGHT_TIME:Ljava/lang/String; = ":settings:fragment_args_light_time"

.field public static final whitelist ARGS_KEY:Ljava/lang/String; = ":settings:fragment_args_key"

.field public static final whitelist ARGS_OPLUS_CATEGORY:Ljava/lang/String; = ":settings:fragment_args_color_category"

.field public static final whitelist ARGS_OPLUS_PREFERENCE:Ljava/lang/String; = ":settings:fragment_args_color_preferece"

.field public static final whitelist ARGS_WAIT_TIME:Ljava/lang/String; = ":settings:fragment_args_wait_time"

.field private static final blacklist DELAY_TIME:I = 0x96

.field public static final whitelist HIGHT_LIGHT_OPLUS_PREFERENCE_DEFAULT:I = -0x1b1b1c

.field public static final whitelist HIGH_LIGHT_TIME_DEFAULT:I = 0x3e8

.field private static final blacklist LAST_TIME:I = 0x1f4

.field public static final whitelist RAW_RENAME_EXTRA_KEY:Ljava/lang/String; = "_settings_extra_key"

.field private static final blacklist START_TIME:I = 0x64

.field private static final blacklist STOP_TIME:I = 0xfa

.field public static final whitelist WAIT_TIME_DEFAULT:I = 0x12c


# direct methods
.method static bridge synthetic blacklist -$$Nest$smcanUseListViewForHighLighting(Landroid/widget/ListView;Ljava/lang/String;)I
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$smgetAnimationDrawable(ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/AnimationDrawable;
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$smshowHightlight(Landroid/widget/ListView;IIZ)V
    .locals 0
...
.method public static whitelist highlightListView(Landroid/widget/ListView;IZLandroid/content/Intent;)V
    .locals 1
    .param p0, "listView"    # Landroid/widget/ListView;
    .param p1, "position"    # I
...
.method public static whitelist highlightListView(Landroid/widget/ListView;IZLandroid/content/Intent;I)V
    .locals 3
    .param p0, "listView"    # Landroid/widget/ListView;
    .param p1, "position"    # I
    .param p2, "isCategory"    # Z
...
.method public static whitelist highlightPreference(Landroid/preference/PreferenceScreen;Landroid/widget/ListView;Landroid/os/Bundle;)V
    .locals 1
    .param p0, "preferenceScreen"    # Landroid/preference/PreferenceScreen;
    .param p1, "listView"    # Landroid/widget/ListView;
...
.method public static whitelist highlightPreference(Landroid/preference/PreferenceScreen;Landroid/widget/ListView;Landroid/os/Bundle;I)V
    .locals 2
    .param p0, "preferenceScreen"    # Landroid/preference/PreferenceScreen;
    .param p1, "listView"    # Landroid/widget/ListView;
    .param p2, "bundle"    # Landroid/os/Bundle;
...
.method public static whitelist highlightPreference(Landroid/widget/ListView;Landroid/os/Bundle;)V
    .locals 1
    .param p0, "listView"    # Landroid/widget/ListView;
...
.method public static whitelist highlightPreference(Landroid/widget/ListView;Landroid/os/Bundle;I)V
    .locals 3
    .param p0, "listView"    # Landroid/widget/ListView;
    .param p1, "bundle"    # Landroid/os/Bundle;
    .param p2, "y"    # I
