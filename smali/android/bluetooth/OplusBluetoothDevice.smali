...
# static fields
.field public static final whitelist TAG:Ljava/lang/String; = "OplusBluetoothDevice"


# instance fields
.field private blacklist mBluetoothDevice:Landroid/bluetooth/BluetoothDevice;


# direct methods
.method public constructor whitelist <init>(Landroid/bluetooth/BluetoothDevice;)V
    .locals 1
...
.method private blacklist connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IILandroid/os/Handler;Z)Landroid/bluetooth/BluetoothGatt;
    .locals 9
    ...
    invoke-direct/range {v0 .. v8}, Landroid/bluetooth/OplusBluetoothDevice;->connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IZILandroid/os/Handler;Z)Landroid/bluetooth/BluetoothGatt;
...
.method private blacklist connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IIZ)Landroid/bluetooth/BluetoothGatt;
    .locals 8
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "autoConnect"    # Z
    .param p3, "callback"    # Landroid/bluetooth/BluetoothGattCallback;
    ...
    invoke-direct/range {v0 .. v7}, Landroid/bluetooth/OplusBluetoothDevice;->connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IILandroid/os/Handler;Z)Landroid/bluetooth/BluetoothGatt;
...
.method private blacklist connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IZILandroid/os/Handler;Z)Landroid/bluetooth/BluetoothGatt;
    .locals 15
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "autoConnect"    # Z
    .param p3, "callback"    # Landroid/bluetooth/BluetoothGattCallback;
    ...
    .line 187
    :cond_1
    new-instance v14, Landroid/bluetooth/BluetoothGatt;
    ...
    invoke-direct/range {v7 .. v13}, Landroid/bluetooth/BluetoothGatt;-><init>(Landroid/bluetooth/IBluetoothGatt;Landroid/bluetooth/BluetoothDevice;IZILandroid/content/AttributionSource;)V
    ...
    const-string v10, "setConnectMode "
...
# virtual methods
.method public whitelist connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IZ)Landroid/bluetooth/BluetoothGatt;
    .locals 7
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "autoConnect"    # Z
    .param p3, "callback"    # Landroid/bluetooth/BluetoothGattCallback;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/bluetooth/OplusBluetoothDevice;->connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IIZ)Landroid/bluetooth/BluetoothGatt;
...
.method public whitelist connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;Z)Landroid/bluetooth/BluetoothGatt;
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "autoConnect"    # Z
    .param p3, "callback"    # Landroid/bluetooth/BluetoothGattCallback;
