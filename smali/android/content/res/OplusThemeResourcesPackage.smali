...
# static fields
.field private static final blacklist TAG:Ljava/lang/String; = "OplusThemeResourcesPackage"

.field private static final blacklist sPackageResources:Ljava/util/Map;
...
.method public constructor blacklist <init>(Landroid/content/res/OplusThemeResourcesPackage;Landroid/content/res/IResourcesImplExt;Ljava/lang/String;Landroid/content/res/OplusThemeResources$MetaData;)V
    .locals 1
    ...
    .line 35
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/content/res/OplusThemeResources;-><init>(Landroid/content/res/OplusThemeResources;Landroid/content/res/IResourcesImplExt;Ljava/lang/String;Landroid/content/res/OplusThemeResources$MetaData;)V
...
.method public static blacklist getThemeResources(Landroid/content/res/IResourcesImplExt;Ljava/lang/String;)Landroid/content/res/OplusThemeResourcesPackage;
    .locals 3
    ...
    .line 48
    invoke-static {p0, p1}, Landroid/content/res/OplusThemeResourcesPackage;->getTopLevelThemeResources(Landroid/content/res/IResourcesImplExt;Ljava/lang/String;)Landroid/content/res/OplusThemeResourcesPackage;
...
.method public static blacklist getTopLevelThemeResources(Landroid/content/res/IResourcesImplExt;Ljava/lang/String;)Landroid/content/res/OplusThemeResourcesPackage;
    .locals 4
    .param p0, "resources"    # Landroid/content/res/IResourcesImplExt;
    .param p1, "pathName"    # Ljava/lang/String;

    .line 62
    invoke-static {p0, p1}, Landroid/content/res/OplusThemeResourcesPackage;->setThemePath(Landroid/content/res/IResourcesImplExt;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, p0, p1, v3}, Landroid/content/res/OplusThemeResourcesPackage;-><init>(Landroid/content/res/OplusThemeResourcesPackage;Landroid/content/res/IResourcesImplExt;Ljava/lang/String;Landroid/content/res/OplusThemeResources$MetaData;)V
