...
# static fields
.field private static final blacklist TAG:Ljava/lang/String; = "OplusThemeResourcesSystem"

.field private static blacklist sOplus:Landroid/content/res/OplusThemeResources;
...
# direct methods
.method public constructor blacklist <init>(Landroid/content/res/OplusThemeResourcesSystem;Landroid/content/res/IResourcesImplExt;Landroid/content/res/OplusThemeResources$MetaData;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0, p3}, Landroid/content/res/OplusThemeResources;-><init>(Landroid/content/res/OplusThemeResources;Landroid/content/res/IResourcesImplExt;Ljava/lang/String;Landroid/content/res/OplusThemeResources$MetaData;)V
...
.method private blacklist getThemeFileStreamOplus(Ljava/lang/String;Ljava/lang/String;)Landroid/content/res/OplusThemeZipFile$ThemeFileInfo;
    .locals 2
...
.method private blacklist getThemeFileStreamSystem(Ljava/lang/String;Ljava/lang/String;)Landroid/content/res/OplusThemeZipFile$ThemeFileInfo;
    .locals 1
    .param p1, "path"    # Ljava/lang/String;
    .param p2, "subPath"    # Ljava/lang/String;
...
.method public static blacklist getTopLevelThemeResources(Landroid/content/res/IResourcesImplExt;)Landroid/content/res/OplusThemeResourcesSystem;
    .locals 4
    ...
    invoke-static {p0, v0}, Landroid/content/res/OplusThemeResources;->getTopLevelThemeResources(Landroid/content/res/IResourcesImplExt;Ljava/lang/String;)Landroid/content/res/OplusThemeResources;
    ...
    invoke-static {p0, v1}, Landroid/content/res/OplusThemeResourcesSystem;->setThemePath(Landroid/content/res/IResourcesImplExt;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, p0, v3}, Landroid/content/res/OplusThemeResourcesSystem;-><init>(Landroid/content/res/OplusThemeResourcesSystem;Landroid/content/res/IResourcesImplExt;Landroid/content/res/OplusThemeResources$MetaData;)V
...
.method public blacklist getLockscreenWallpaper()Ljava/io/File;
    .locals 1
...
.method public blacklist getThemeInt(II)Ljava/lang/Integer;
    .locals 2
    .param p1, "id"    # I
    .param p2, "index"    # I
...
.method public blacklist setResource(Landroid/content/res/IResourcesImplExt;)V
    ...
    invoke-virtual {v0, p1}, Landroid/content/res/OplusThemeResources;->setResource(Landroid/content/res/IResourcesImplExt;)V

    .line 124
    invoke-super {p0, p1}, Landroid/content/res/OplusThemeResources;->setResource(Landroid/content/res/IResourcesImplExt;)V
