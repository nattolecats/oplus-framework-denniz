...
# static fields
.field private static final blacklist DARK_MODE_STATE_DEFAULT:I = 0x0

.field private static final blacklist DARK_MODE_STATE_OPEN:I = 0x1

.field private static final blacklist DARK_WALLPAPER_SETTINGS_STATE:Ljava/lang/String; = "oplus_customize_settings_dark_wallpaper"

.field private static final blacklist NIGHT_MODE:I = 0x20

.field private static final blacklist NIGHT_MODE_FLAG:I = 0x30

.field private static final blacklist TAG:Ljava/lang/String; = "OplusWallpaperServiceHelper"

.field private static blacklist sNightMode:Z


# instance fields
.field private final blacklist mActiveEngines:Ljava/util/ArrayList;
...
.field private blacklist mDarkWallpaperSettingsChangeObserver:Landroid/service/wallpaper/OplusWallpaperServiceHelper$DarkWallpaperSettingsChangeObserver;

.field private blacklist mHandlerThread:Landroid/os/HandlerThread;

.field private blacklist mIsRegisterDarkWallpaperContentObserver:Z


# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmDarkWallpaperSettingsChangeObserver(Landroid/service/wallpaper/OplusWallpaperServiceHelper;)Landroid/service/wallpaper/OplusWallpaperServiceHelper$DarkWallpaperSettingsChangeObserver;
    .locals 0

    iget-object p0, p0, Landroid/service/wallpaper/OplusWallpaperServiceHelper;->mDarkWallpaperSettingsChangeObserver:Landroid/service/wallpaper/OplusWallpaperServiceHelper$DarkWallpaperSettingsChangeObserver;

    return-object p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmIsRegisterDarkWallpaperContentObserver(Landroid/service/wallpaper/OplusWallpaperServiceHelper;)Z
    .locals 0

    iget-boolean p0, p0, Landroid/service/wallpaper/OplusWallpaperServiceHelper;->mIsRegisterDarkWallpaperContentObserver:Z

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$fputmDarkWallpaperSettingsChangeObserver(Landroid/service/wallpaper/OplusWallpaperServiceHelper;Landroid/service/wallpaper/OplusWallpaperServiceHelper$DarkWallpaperSettingsChangeObserver;)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$fputmIsRegisterDarkWallpaperContentObserver(Landroid/service/wallpaper/OplusWallpaperServiceHelper;Z)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mupdateEngineSurface(Landroid/service/wallpaper/OplusWallpaperServiceHelper;)V
    .locals 0
...
.method public constructor whitelist <init>()V
    ...
    const-string v1, "wallpaper-helper"
...
.method public static whitelist getDarkModeWallpaperWindowAlpha(Landroid/content/Context;)F
    .locals 5
...
.method private static blacklist getDarkWallpaperSwitchSettings(Landroid/content/Context;)Z
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
...
.method private static blacklist isDarkModeWallpaperSwitchOpened(Landroid/content/Context;)Z
    .locals 1
    .param p0, "context"    # Landroid/content/Context;
...
.method private static blacklist isNightMode(Landroid/content/Context;)Z
    .locals 8
    .param p0, "context"    # Landroid/content/Context;
...
.method private blacklist updateEngineSurface()V
    .locals 5
    ...
    const-string v1, "updateEngineSurface mActiveEngine size is: "
    ...
    const-string v4, "updateEngineSurface engine: "
...
# virtual methods
.method public whitelist addEngine(Landroid/service/wallpaper/WallpaperService$Engine;)V
    .locals 2
...
.method public whitelist registerSetingsContentObserver(Landroid/content/Context;)V
    .locals 3
    ...
    const-string v1, "registerSetingsContentObserver mIsRegisterDarkWallpaperContentObserver = "
...
.method public whitelist removeEngine(Landroid/service/wallpaper/WallpaperService$Engine;)V
    .locals 2
    .param p1, "engine"    # Landroid/service/wallpaper/WallpaperService$Engine;
    ...
    const-string v1, "removeEngine engine= "
...
.method public whitelist unregisterSettingsContentObserver(Landroid/content/Context;)V
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
    ...
    const-string v1, "unregisterSettingsContentObserver mIsRegisterDarkWallpaperContentObserver = "
