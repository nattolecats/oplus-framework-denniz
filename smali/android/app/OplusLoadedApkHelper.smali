...
.method public static whitelist addSpecialLibraries(Landroid/content/pm/ApplicationInfo;Ljava/util/List;)V
    .locals 8
    ...
    const-string v2, "specialNativeLibraryDirs"
    ...
    :cond_4
    iget-object v2, p0, Landroid/content/pm/ApplicationInfo;->mApplicationInfoExt:Landroid/content/pm/IApplicationInfoExt;

    .line 77
    .local v2, "appInfoExt":Landroid/content/pm/IApplicationInfoExt;
    :goto_3
    if-eqz v2, :cond_5

    .line 78
    invoke-interface {v2}, Landroid/content/pm/IApplicationInfoExt;->getPrivateFlags()I
...
.method public static whitelist addSpecialZipPaths(Landroid/content/pm/ApplicationInfo;Ljava/util/List;)V
    .locals 0
    .param p0, "aInfo"    # Landroid/content/pm/ApplicationInfo;
    .annotation system Ldalvik/annotation/Signature;
        value = {
