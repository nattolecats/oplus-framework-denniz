...
.field private static final blacklist DEFAULT_BRIGHTNESS:F = 0.8f

.field private static final blacklist DEFAULT_RADIUS:I = 0x19

.field private static final blacklist EXECUTOR:Ljava/util/concurrent/ExecutorService;

.field private static final blacklist EXECUTOR_THREADS:I

.field public static final whitelist MAX_BRIGHTNESS:F = 1.0f

.field public static final whitelist MINIM_BRIGHTNESS:F = 0.0f

.field private static final blacklist TAG:Ljava/lang/String; = "GaussianBlur"

.field private static blacklist sGaussianBlur:Lcom/oplus/launcher/graphic/GaussianBlur;

.field public static whitelist sScreenHeight:I

.field public static whitelist sScreenWidth:I


# instance fields
.field private blacklist mBitmap:Landroid/graphics/Bitmap;

.field private blacklist mBitmapMapMemoryCache:Landroid/util/SparseArray;
...
.field private blacklist mInoutPixelMapMemoryCache:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "[I>;"
...
.field private blacklist mInoutPixels:[I
...
.method public static whitelist getInstance()Lcom/oplus/launcher/graphic/GaussianBlur;
    .locals 1
...
.method public static whitelist scaleBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 2
...
.method public static whitelist scaleBitmap(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    .locals 11
    .param p0, "bm"    # Landroid/graphics/Bitmap;
    .param p1, "scale"    # F
...
.method public static whitelist setScreenWidth(Landroid/content/Context;)V
    .locals 7
...
# virtual methods
.method public native whitelist blurBrightness_native([IIIF)V
.end method

.method public native whitelist blurIterationAlpha_native([IIIIIII)V
.end method

.method public native whitelist blurIteration_native([IIIIIII)V
.end method

.method public whitelist blurIteration_native([IIIIZ)V
    .locals 16
    .param p1, "inout"    # [I
    .param p2, "width"    # I
    .param p3, "height"    # I
...
.method public whitelist blurIteration_nativeTask([IIIIZ)V
    .locals 16
    .param p1, "inout"    # [I
    .param p2, "width"    # I
    .param p3, "height"    # I
...
.method public whitelist captureScreen(Landroid/content/Context;IIFII)Landroid/graphics/Bitmap;
    .locals 4
...
.method public whitelist generateGaussianBitmap(Landroid/graphics/Bitmap;FZ)Landroid/graphics/Bitmap;
    .locals 1
...
.method public whitelist generateGaussianBitmap(Landroid/graphics/Bitmap;IFZ)Landroid/graphics/Bitmap;
    .locals 6
    .param p1, "bmp"    # Landroid/graphics/Bitmap;
    .param p2, "radius"    # I
...
.method public whitelist generateGaussianBitmap(Landroid/graphics/Bitmap;IFZZ)Landroid/graphics/Bitmap;
    .locals 20
    .param p1, "bmp"    # Landroid/graphics/Bitmap;
    .param p2, "radius"    # I
    .param p3, "brightness"    # F
    ...
    .line 227
    const-string v4, "GaussianBlur:generateGaussianBitmap  Enter"
    ...
    .line 233
    .local v8, "inoutPixels":[I
    sget-object v5, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-static {v4, v9, v5}, Landroid/graphics/Bitmap;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v5 .. v10}, Lcom/oplus/launcher/graphic/GaussianBlur;->blurIteration_native([IIIIZ)V

    .line 241
    if-eqz v3, :cond_4

    .line 242
    const-string v5, "GaussianBlur:generateGaussianBitmap  generate brightness"
    ...
    invoke-virtual {v5, v15, v14, v4, v1}, Lcom/oplus/launcher/graphic/GaussianBlur;->blurBrightness_native([IIIF)V
    ...
    .restart local v8    # "inoutPixels":[I
    move v15, v6
...
.method public whitelist generateGaussianBitmap(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    .locals 2
    .param p1, "bmp"    # Landroid/graphics/Bitmap;
    .param p2, "recycle"    # Z
...
.method public whitelist generateGaussianBitmapResuse(Landroid/graphics/Bitmap;IFZ)Landroid/graphics/Bitmap;
    .locals 20
    .param p1, "bmp"    # Landroid/graphics/Bitmap;
    .param p2, "radius"    # I
    .param p3, "brightness"    # F
    ...
    .line 170
    :cond_0
    sget-boolean v17, Lcom/oplus/launcher/graphic/GaussianBlur;->DEBUG:Z
    ...
    .local v18, "bitmapCache":Landroid/graphics/Bitmap;
    move-object v1, v9

    move-object/from16 v19, v2

    .end local v2    # "pixelCache":[I
    .local v19, "pixelCache":[I
    move v2, v4
    ...
    .end local v18    # "bitmapCache":Landroid/graphics/Bitmap;
    .end local v19    # "pixelCache":[I
    .restart local p1    # "bmp":Landroid/graphics/Bitmap;
    :cond_9
    :goto_3
...
.method public whitelist generateGaussianBitmapTask(Landroid/graphics/Bitmap;IFZZ)Landroid/graphics/Bitmap;
    .locals 18
    .param p1, "bmp"    # Landroid/graphics/Bitmap;
    .param p2, "radius"    # I
    .param p3, "brightness"    # F
    ...
    .line 268
    :cond_0
    sget-boolean v10, Lcom/oplus/launcher/graphic/GaussianBlur;->DEBUG:Z
    ...
    invoke-virtual/range {v11 .. v16}, Lcom/oplus/launcher/graphic/GaussianBlur;->blurIteration_nativeTask([IIIIZ)V
    ...
    invoke-virtual {v11, v9, v8, v7, v0}, Lcom/oplus/launcher/graphic/GaussianBlur;->blurBrightness_native([IIIF)V
    ...
    .end local v14    # "inoutPixels":[I
    .end local v16    # "isAlpha":Z
...
.method public whitelist generateGaussianScreenshot(Landroid/content/Context;FIF)Landroid/graphics/Bitmap;
    .locals 7
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "scale"    # F
    .param p3, "radius"    # I
...
.method public whitelist generateGaussianWallpaper(Landroid/content/Context;FIF)Landroid/graphics/Bitmap;
    .locals 10
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "scale"    # F
    .param p3, "radius"    # I
...
.method public whitelist releaseResource()V
    .locals 5
...
.method public whitelist setParameter(III)V
    .locals 0
    .param p1, "h"    # I
    .param p2, "v"    # I
    .param p3, "i"    # I
