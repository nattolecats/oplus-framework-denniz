...
# instance fields
.field private blacklist mAdapter:Landroid/widget/ListAdapter;

.field private blacklist mBuilder:Landroid/app/AlertDialog$Builder;

.field private blacklist mContext:Landroid/content/Context;

.field private blacklist mCustomRes:I

.field private blacklist mCustomView:Landroid/view/View;

.field private blacklist mDialog:Landroid/app/AlertDialog;

.field private blacklist mHasCustom:Z
...
.field private blacklist mOnClickListener:Landroid/content/DialogInterface$OnClickListener;

.field private blacklist mTextAppearances:[I


# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmDialog(Lcom/oplus/dialog/OplusListDialog;)Landroid/app/AlertDialog;
    .locals 0

    iget-object p0, p0, Lcom/oplus/dialog/OplusListDialog;->mDialog:Landroid/app/AlertDialog;

    return-object p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmMessageView(Lcom/oplus/dialog/OplusListDialog;)Landroid/widget/TextView;
    .locals 0

    iget-object p0, p0, Lcom/oplus/dialog/OplusListDialog;->mMessageView:Landroid/widget/TextView;

    return-object p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmOnClickListener(Lcom/oplus/dialog/OplusListDialog;)Landroid/content/DialogInterface$OnClickListener;
    .locals 0

    iget-object p0, p0, Lcom/oplus/dialog/OplusListDialog;->mOnClickListener:Landroid/content/DialogInterface$OnClickListener;
...
.method private blacklist getAdapter()Landroid/widget/ListAdapter;
    .locals 4
...
.method private blacklist setupCustomPanel(Landroid/view/View;)V
    .locals 4
...
.method private blacklist setupListPanel(Landroid/view/View;)V
    .locals 2
    .param p1, "parentPanel"    # Landroid/view/View;
...
.method private blacklist setupMessage(Landroid/view/View;)V
    .locals 3
    .param p1, "parentPanel"    # Landroid/view/View;
...
.method public blacklist create()Landroid/app/AlertDialog;
    .locals 3
...
.method public blacklist getDialog()Landroid/app/AlertDialog;
    .locals 1
...
.method public blacklist setAdapter(Landroid/widget/ListAdapter;)Lcom/oplus/dialog/OplusListDialog;
    .locals 0
...
.method public blacklist setCustomView(I)Lcom/oplus/dialog/OplusListDialog;
    .locals 1
    .param p1, "layout"    # I
...
.method public blacklist setCustomView(Landroid/view/View;)Lcom/oplus/dialog/OplusListDialog;
    .locals 1
...
.method public blacklist setItems([Ljava/lang/CharSequence;[ILandroid/content/DialogInterface$OnClickListener;)Lcom/oplus/dialog/OplusListDialog;
    .locals 0
...
.method public blacklist setMessage(Ljava/lang/CharSequence;)Lcom/oplus/dialog/OplusListDialog;
    .locals 0
...
.method public blacklist setTitle(Ljava/lang/CharSequence;)Lcom/oplus/dialog/OplusListDialog;
    .locals 1
