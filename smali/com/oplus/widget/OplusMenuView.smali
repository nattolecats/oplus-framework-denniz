...
# static fields
.field private static final blacklist DISPLAYDSEN:I = 0xa0

.field private static blacklist IETMNUMBERS:I = 0x0

.field static final blacklist MAX_MENU_ITEM_COUNTS:I = 0x5

.field static final blacklist STATE_ENABLED:[I

.field static final blacklist STATE_NORMAL:[I

.field static final blacklist STATE_PRESSED:[I

.field static final blacklist STATE_UNENABLED:[I

.field private static final blacklist TAG:Ljava/lang/String; = "OplusMenuView"

.field static final blacklist VIEW_STATE_ENABLED:I = 0x101009e

.field static final blacklist VIEW_STATE_PRESSED:I = 0x10100a7


# instance fields
.field private blacklist mBottom:[I

.field private blacklist mIconTextDis:I
...
.field private blacklist mLeft:[I

.field private blacklist mNormalColor:I

.field private blacklist mOnclickRunnable:Ljava/lang/Runnable;

.field private blacklist mOplusItemList:Ljava/util/List;
...
.field private blacklist mRight:[I

.field private blacklist mScale:F

.field private blacklist mSelectRect:Landroid/graphics/Rect;

.field private blacklist mSelectedColor:I
...
.field private final blacklist mTouchHelper:Lcom/android/internal/widget/OplusViewExplorerByTouchHelper;


# direct methods
.method static bridge synthetic blacklist -$$Nest$fgetmOplusItemList(Lcom/oplus/widget/OplusMenuView;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lcom/oplus/widget/OplusMenuView;->mOplusItemList:Ljava/util/List;

    return-object p0
.end method

.method static bridge synthetic blacklist -$$Nest$fgetmSelectedPosition(Lcom/oplus/widget/OplusMenuView;)I
    .locals 0

    iget p0, p0, Lcom/oplus/widget/OplusMenuView;->mSelectedPosition:I

    return p0
.end method

.method static bridge synthetic blacklist -$$Nest$mgetRect(Lcom/oplus/widget/OplusMenuView;ILandroid/graphics/Rect;)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mselectedIndex(Lcom/oplus/widget/OplusMenuView;FF)I
    .locals 0
...
.method private blacklist getRect(ILandroid/graphics/Rect;)V
    .locals 6
    .param p1, "index"    # I
...
.method private blacklist initStateListDrawable(I)V
    .locals 4
    .param p1, "i"    # I
...
.method private blacklist selectedIndex(FF)I
    .locals 2
    .param p1, "eventX"    # F
    .param p2, "eventY"    # F
...
.method public whitelist setItem(Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
