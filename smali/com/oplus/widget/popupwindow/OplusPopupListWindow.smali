...
# instance fields
.field private blacklist mAdapter:Landroid/widget/BaseAdapter;

.field private blacklist mAlphaAnimationDuration:I

.field private blacklist mAlphaAnimationInterpolator:Landroid/view/animation/Interpolator;

.field private blacklist mAnchor:Landroid/view/View;

.field private blacklist mAnchorRect:Landroid/graphics/Rect;

.field private blacklist mAnimationListener:Landroid/view/animation/Animation$AnimationListener;

.field private blacklist mBackgroundPaddingRect:Landroid/graphics/Rect;

.field private blacklist mBottomPanel:Landroid/widget/FrameLayout;

.field private blacklist mContentPanel:Landroid/widget/LinearLayout;

.field private blacklist mContentView:Landroid/view/ViewGroup;

.field private blacklist mContext:Landroid/content/Context;

.field private blacklist mCoordinate:Landroid/graphics/Point;

.field private blacklist mCustomAdapter:Landroid/widget/BaseAdapter;

.field private blacklist mDecorViewRect:Landroid/graphics/Rect;

.field private blacklist mDefaultAdapter:Landroid/widget/BaseAdapter;

.field private blacklist mHasHorizontalSpace:Z

.field private blacklist mHasVerticalSpace:Z

.field private blacklist mIsDismissing:Z

.field private blacklist mItemList:Ljava/util/List;
...
.field private blacklist mListContainer:Lcom/oplus/widget/OplusMaxLinearLayout;

.field private blacklist mListView:Landroid/widget/ListView;

.field private blacklist mListViewUsedToMeasure:Landroid/widget/ListView;

.field private blacklist mOnItemClickListener:Landroid/widget/AdapterView$OnItemClickListener;

.field private blacklist mParentRectOnScreen:Landroid/graphics/Rect;

.field private blacklist mPivotX:F

.field private blacklist mPivotY:F

.field private blacklist mPopupListMaxHeight:I

.field private blacklist mPopupListMaxWidth:I

.field private blacklist mPopupListSelection:I

.field private blacklist mPopupListSelectionScrollOffset:I

.field private blacklist mPopupListWindowMinWidth:I

.field private blacklist mPopupWindowOffset:[I

.field private blacklist mScaleAnimationDuration:I

.field private blacklist mScaleAnimationInterpolator:Landroid/view/animation/Interpolator;

.field private blacklist mShowAboveFirst:Z

.field private blacklist mTempLocation:[I

.field private blacklist mWindowLocationOnScreen:[I


# direct methods
.method static bridge synthetic blacklist -$$Nest$fputmIsDismissing(Lcom/oplus/widget/popupwindow/OplusPopupListWindow;Z)V
    .locals 0
...
.method static bridge synthetic blacklist -$$Nest$mdismissPopupWindow(Lcom/oplus/widget/popupwindow/OplusPopupListWindow;)V
    .locals 0
...
.method private blacklist animateEnter()V
    .locals 10
...
.method private blacklist animateExit()V
    .locals 10
...
.method private blacklist calculateCoordinate()V
    .locals 12
...
.method private blacklist calculatePivot()V
    .locals 5
...
.method private blacklist calculateWindowLocation()V
    .locals 8
...
.method private blacklist createContentView(Landroid/content/Context;)Landroid/view/ViewGroup;
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
...
.method private blacklist dismissPopupWindow()V
    .locals 1
...
.method private blacklist getPopupWindowMaxWidth()I
    .locals 2
...
# virtual methods
.method public whitelist addBottomPanel(Landroid/view/View;)V
    .locals 1
...
.method public whitelist getItemList()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public whitelist measurePopupWindow()V
    .locals 17
...
.method public whitelist setAdapter(Landroid/widget/BaseAdapter;)V
    .locals 0
...
.method public whitelist setDismissTouchOutside(Z)V
    .locals 1
...
.method public whitelist setItemList(Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public whitelist setListLandscapeMaxHeight(I)V
    .locals 1
    .param p1, "maxValue"    # I
...
.method public whitelist setListLandscapeMaxWidth(I)V
    .locals 1
    .param p1, "maxValue"    # I
...
.method public whitelist setListPortraitMaxHeight(I)V
    .locals 1
    .param p1, "maxValue"    # I
...
.method public whitelist setListPortraitMaxWidth(I)V
    .locals 1
    .param p1, "maxValue"    # I
...
.method public whitelist setOffset(IIII)V
    .locals 2
    .param p1, "left"    # I
    .param p2, "top"    # I
    .param p3, "right"    # I
...
.method public whitelist show(Landroid/view/View;)V
    .locals 6
...
.method public whitelist showAboveFirst(Z)V
    .locals 0
