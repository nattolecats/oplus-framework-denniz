...
# static fields
.field public static final whitelist ACCURACY:I = 0x2

.field private static final blacklist ALPHA_SHOW_DURATION:I = 0x168

.field private static final blacklist BASE_PROGRESS_POINT_ALPHA:F = 0.215f

.field public static final whitelist DEFAULT_TYPE:I = 0x0

.field public static final whitelist LARGE_TYPE:I = 0x2

.field public static final whitelist MEDIUM_TYPE:I = 0x1

.field private static final blacklist ONE_CIRCLE_DEGREE:I = 0x168

.field public static final whitelist ORIGINAL_ANGLE:I = -0x5a

.field private static final blacklist PROGRESS_POINT_COUNT:I = 0x168

.field private static final blacklist TAG:Ljava/lang/String; = "OplusCircleProgressBar"
...
.field private blacklist mAccessibilityEventSender:Lcom/oplus/widget/OplusCircleProgressBar$AccessibilityEventSender;

.field private blacklist mArcRect:Landroid/graphics/RectF;

.field private blacklist mBackGroundPaint:Landroid/graphics/Paint;
...
.field private blacklist mPointList:Ljava/util/ArrayList;
...
.field private blacklist mPointRadius:I

.field private blacklist mPreStepProgress:I
...
.field private blacklist mProgressBarType:I

.field private blacklist mProgressPaint:Landroid/graphics/Paint;

.field private blacklist mStepDegree:F

.field private blacklist mStrokeDefaultWidth:I

.field private blacklist mStrokeLargeWidth:I

.field private blacklist mStrokeMediumWidth:I
...
.method public constructor whitelist <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mWidth:I
    ...
    iput v5, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mHeight:I
    ...
    invoke-static {p1, v0}, Lcom/oplus/util/OplusContextUtil;->getAttrColor(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v5}, Lcom/oplus/util/OplusContextUtil;->getAttrColor(Landroid/content/Context;I)I

    move-result v5

    .line 97
    .local v5, "defaultBgCircleColor":I
    const/4 v6, 0x3
    ...
    iput v6, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mMax:I
    ...
    iput v6, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeDefaultWidth:I
    ...
    iput v6, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeMediumWidth:I
    ...
    iput v6, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeLargeWidth:I

    .line 105
    iget v7, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeDefaultWidth:I

    iput v7, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeWidth:I

    .line 106
    iget v7, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mProgressBarType:I

    if-ne v3, v7, :cond_0

    .line 107
    iget v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeMediumWidth:I

    iput v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeWidth:I
    ...
    :cond_1
    :goto_0
    iget v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mStrokeWidth:I

    shr-int/2addr v4, v3

    iput v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mPointRadius:I

    .line 112
    iget v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mWidth:I

    shr-int/2addr v4, v3

    int-to-float v4, v4

    iput v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mCenterX:F

    .line 113
    iget v4, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mHeight:I

    shr-int/lit8 v3, v4, 0x1

    int-to-float v3, v3

    iput v3, p0, Lcom/oplus/widget/OplusCircleProgressBar;->mCenterY:F
...
.method private blacklist drawBackgroudCicle(Landroid/graphics/Canvas;)V
    .locals 4
...
.method private blacklist initBackgroundPaint()V
    .locals 2
...
.method private blacklist scheduleAccessibilityEventSender()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/oplus/widget/OplusCircleProgressBar$AccessibilityEventSender;-><init>(Lcom/oplus/widget/OplusCircleProgressBar;Lcom/oplus/widget/OplusCircleProgressBar$AccessibilityEventSender-IA;)V
